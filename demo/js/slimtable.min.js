    ...
    e.fn.slimtable = function (t) {
        ...
        function h() {
            o.find("th").each(function (t) {
                ...
                if (r[t] && r[t].sortable) {
                    ...
                    e(n).addClass("slimtable-sprites"), e(n).attr("unselectable", "on"), r[t].sordir == "asc" ? e(n).addClass("slimtable-sortasc") : r[t].sordir == "desc" ? e(n).addClass("slimtable-sortdesc") : e(n).addClass("slimtable-sortboth"), e(this).prepend(n).css({cursor: "pointer"}).on("click", g)
                }
            })
        }
        ...
        function p() {
            ...
            for (var i = 0; i < t.length; i++) {
                var a = !0, f = [];
                for (var l = 0; l < n.colSettings.length; l++) if (n.colSettings[l].colNumber == i) {
                ...
                r[i] = {sortable: a, classes: f, sortdir: "asc"}
            }
        ...
        function d() {
            ...
            for (var c = f; c < t; c++) {
                ...
                for (var h = 0; h < s[c].length; h++) {
                    ...
                    for (var p = 0; p < r[h].classes.length; p++) e(i).addClass(r[h].classes[p]);
                    e(n).append(i)
                }
                u.append(n)
            }
            e(a).empty(), o = Math.ceil(s.length / l);
            for (var c = 0; c < o; c++) n = document.createElement("div"), e(n).addClass("slimtable-page-btn"), e(n).on("click", v), e(n).text(c + 1), c * l == f && e(n).addClass("active"), e(a).append(n)
        }
        ...
        function g(t) {
            ...
            i.length > 0 && s.sort(function (e, t) {
                var n, s;
                for (var o = 0; o < i.length; o++) return n = i[o], e[n] == t[n] && o < i.length - 1 ? (s = i[o + 1], y(e[s], t[s], r[s].sortdir)) : y(e[n], t[n], r[n].sortdir)
            }), d()
        }
        ...
        var n = e.extend({tableData: null, itemsPerPage: 10, ipp_list: [5, 10, 20], colSettings: []}, t), r = [],
            i = [], s = [], o, u, a, f, l;
